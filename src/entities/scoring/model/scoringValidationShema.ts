...
//     }),
//     salary: z.number({ required_error: 'Enter your salary' }).positive(),
//     position: z.union([
//         z.literal('WORKER'),
...
export const scoringValidationShema = z.object({
    ...
    employerINN: z
        .string()
        .regex(/^\d{12}$/, { message: 'Department code must be 12 digits' }),
    salary: z.coerce.number().positive({ message: 'Enter your salary' }),
    position: z.union(
        [
            z.literal('WORKER'),
            z.literal('MID_MANAGER'),
    ...
    workExperienceCurrent: z.coerce
        ...
        .min(1, { message: 'Enter your current work experience' })
        .max(99, {
            message: "Current experience can't be more than 2 digits",
        }),
})
